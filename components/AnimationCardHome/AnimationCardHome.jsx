  ...
  useGSAP(
    () => {
      ...
      mm.add("(min-width: 1024px)", () => {
        ...
        /*
      PSEUDOCODE (anti-scatti + reveal corretto)
      1) Stack iniziale:
         - tutti i pannelli assoluti, primo sopra.
      2) Stato iniziale animazioni:
         - left cards tutte fuori scena (basso/sinistra).
         - right reveal:
           * prima visibile
           * altre nascoste dal basso con clip-path.
      3) Timeline con scroll scrub (NO snap):
         - step iniziale: entra left[0].
         - per ogni card successiva:
           a) porta il pannello successivo in cima PRIMA del tween (niente scatto a fine step),
           b) rivela la sua immagine destra dal basso (clip-path),
           c) fai entrare la sua left da basso/sinistra.
      4) Le card precedenti non spariscono: restano sotto in stack.
      */
