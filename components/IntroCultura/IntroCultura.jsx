...
export const IntroCultura = ({ blocks }) => {
  ...
  useGSAP(
    () => {
      const heading = container.current?.querySelector(".intro-cultura-heading");
      const line = container.current?.querySelector(".intro-cultura-line");
      const para = container.current?.querySelector(".intro-cultura-para");
      ...
      <div className="px-5 max-w-3xl mx-auto text-center">
        {headingBlock && (
          <Heading
            ...
            className="intro-cultura-heading font-montecatini font-normal text-5xl lg:text-7xl text-blue tracking-wide"
          />
        )}

        <div
          className="intro-cultura-line mx-auto mt-6 mb-8 h-px w-16 bg-gray/30"
        ...
        {paragraphBlock && (
          <Paragraph
            ...
            className="intro-cultura-para font-nunito font-light text-text text-base lg:text-xl leading-relaxed"
          />
        )}
      </div>
    </section>
