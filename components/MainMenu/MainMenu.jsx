  ...
  return (
    <>
          ...
          <div className="flex items-center gap-5">
            ...
            >
              ...
              <span
                className={`block h-px transition-all duration-400 origin-center ${
                  isOpen
                    ? "bg-blue -rotate-45 -translate-y-[8.5px]"
                    : "bg-white"
                }`}
              />
            </button>
      ...
      >
        <div
          ref={logoRef}
          className="hidden lg:block absolute left-10 top-24 z-20 isolate"
        >
          <svg
            id="a"
        ...
        <nav ref={menuNavRef}>
          {nodes
            ...
            .map((item, idx) => {
              console.log(item.label, item.childItems?.nodes);
              return (
                <div key={item.uri ?? idx}>
                  {/* Voce principale */}
                  <Link
                    href={item.uri}
                  ...
                  {item.childItems?.nodes?.length > 0 && (
                    <div className="pl-6 pb-2">
                      {item.childItems.nodes.map((child, childIdx) => (
                        <Link
